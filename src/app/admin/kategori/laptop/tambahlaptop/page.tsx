      ...
      <div className="w-full p-3 md:w-2/3 lg:w-1/2"> {/* Added responsive width */}
        <Card className="bg-white rounded-lg shadow-md"> {/* Added shadow */}
          <CardHeader className="p-4"> {/* Added padding to header */}
            <CardTitle className="text-xl font-semibold text-gray-800">Tambah Kategori Laptop</CardTitle>
            <CardDescription className="text-gray-600">Tambahkan kategori laptop</CardDescription>
          </CardHeader>
          <CardContent className="p-6"> {/* Added padding to content */}
            <form>
              <div className="grid w-full items-center gap-6">
                <div className="flex flex-col space-y-2">
                  <Label htmlFor="nama-laptop" className="text-gray-700">Nama Kategori Laptop</Label>
                  <Input
                    id="nama-laptop"
                    placeholder="Misalnya: Gaming, Ultrabook, dll."
